...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 * 		Document bDoc = new BasicDocument(textfile);
			 * 		bDoc.getFleschScore();
			 * }
			 ...
			 * for (int i=0; i<trials; i++) {
			 * 		Document eDoc = new EfficientDocument(string);
			 * 		eDoc.getFleschScore();
			 * }
			 ...
			 * double efficientTime = (efficientEnd - efficientStart)/100000000.0;
			...
			long basicStart = System.nanoTime();
			for (int i=0; i< trials; i++) {
			  	Document bDoc = new BasicDocument(string);
			  	bDoc.getFleschScore();
			}
			long basicEnd = System.nanoTime();
			double basicTime = (basicEnd - basicStart)/100000000.0;
