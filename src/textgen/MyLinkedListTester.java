...
public class MyLinkedListTester {
	...
	public static void main(String[] args) throws Exception {
		MyLinkedListTester tester = new MyLinkedListTester();
		tester.setUp();
		tester.testGet();
		tester.testRemove();
		tester.testAddEnd();
	...
	public void testAddEnd()
	{
		...
		assertEquals("addEnd: check element 4 is correct ", (Integer)10, list1.get(4));
	...
	public void testAddAtIndex()
	{
        // TODO: implement this test
		list1.add(1,15);
		assertEquals("addAtIndex: check element 1 is correct ", (Integer)15, list1.get(1));
