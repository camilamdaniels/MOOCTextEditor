...
public class NearbyWords implements SpellingSuggest {
	...
	// input(word): word for which to provide number of spelling suggestions
	// input(numSuggestions): number of maximum suggestions to provide
	// output(retList): list of spelling suggestions
	@Override
